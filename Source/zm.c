...
fifi:
	...
	case RCDO:
	case GCOUNT:
		log3("Got %s (@ fifi)", frametypes[c+FTOFFSET]);
	/* **** FALL THRU TO **** */
#ifndef DSZ
	default:
		if (c >= -4 && c <= FRTYPES)
