...
void stsleep P_((int n));
void initz P_((void));
void aexit P_((int n));
void buserr P_((void));
void addrerr P_((void));
void bttyout P_((int c));
#ifdef CPM
void sendline P_((int c));
void flush_modem P_((void));
#else
static inline void sendline P_((int c));
static inline void flush_modem P_((void));
#endif
...
void report P_((int sct));
void lreport P_((long sct));
int _initargs P_((void));
void wr_modem P_((char *s));
